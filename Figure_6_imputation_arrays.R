...
setwd("array_analysis/impute_acc")
...
pdf(file="../../Figure_6_imputation_arrays.pdf",  width=8, height=7)
p
dev.off()
...
#df$Population[df$Population == "VNP"] = "VNP"

fwrite(df, "../../Figure_6_imputation_arrays_statistics.csv", sep = "\t", row.names = F)
...
# 	# path_res="/media/datn/data/1st_DC_sever/LmTag_GWAS_CLINVAR/tags_32000/tag_snp_with_cadd_score/LmTag_K50_VNP.Rdata"
